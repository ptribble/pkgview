...
public class InstalledFilesPanel extends JPanel {
     ...
     *
     * @param plist A list of packages
     * @param ctoc  A parsed ClusterToc
     */
    public InstalledFilesPanel(PkgList plist, ClusterToc ctoc) {
	setLayout(new BorderLayout());

	JPanel jptree = new JPanel(new BorderLayout());
	pip = new PackageInformationPanel(plist, ctoc, false);
	...
	final JTree cft = new ContentsFileTree();
